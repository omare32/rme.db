...
def insert_to_mysql(df, table_name, drop_and_create=True):
    try:
...
def main():
    # TODO: Edit this query to your required Oracle view or SQL
    oracle_query = "SELECT * FROM YOUR_ORACLE_VIEW_OR_SQL"
    # TODO: Edit this to your target MySQL table name
    mysql_table = "TARGET_MYSQL_TABLE"
