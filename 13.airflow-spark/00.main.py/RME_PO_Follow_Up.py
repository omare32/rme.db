...
def RME_PO_Follow_Up_ETL():
    spark = fx.spark_app('RME_PO_Follow_Up','4g','4')
    RES = fx.connection(spark,'RES','RMEDB',RME_PO_Follow_Up_query,'TEMP','ERP')
...
dag = DAG('RME_PO_Follow_Up',catchup=False,default_args=default_args,schedule_interval='30 2 * * *',tags=['2'])


RME_PO_Follow_UpTask= PythonOperator(dag=dag,
                task_id = 'RME_PO_Follow_Up',
                python_callable=RME_PO_Follow_Up_ETL) 
...
delete_dataTask >> RME_PO_Follow_UpTask
