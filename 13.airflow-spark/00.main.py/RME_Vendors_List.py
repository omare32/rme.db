...
def RME_Vendors_List_ETL():
    spark = fx.spark_app('RME_Vendors_List','4g','4')
    RES = fx.connection(spark,'RES','RMEDB',RME_Vendors_List_query,'TEMP','ERP')
...
dag = DAG('RME_Vendors_List',catchup=False,default_args=default_args,schedule_interval='45 4 * * *',tags=['4'])


RME_Vendors_ListTask= PythonOperator(dag=dag,
                task_id = 'RME_Vendors_List',
                python_callable=RME_Vendors_List_ETL) 


RME_Vendors_ListTask
