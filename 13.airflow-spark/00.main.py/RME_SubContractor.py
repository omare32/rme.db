...
def RME_SubContractor_ETL():
    spark = fx.spark_app('RME_SubContractor','12g','4')
    RES = fx.connection(spark,'RES','RMEDB',RME_SubContractor_query,'TEMP','ERP')
...
dag = DAG('RME_SubContractor',catchup=False,default_args=default_args,schedule_interval='0 4 * * *',tags=['4'])


RME_SubContractorTask= PythonOperator(dag=dag,
                task_id = 'RME_SubContractor',
                python_callable=RME_SubContractor_ETL) 


RME_SubContractorTask
