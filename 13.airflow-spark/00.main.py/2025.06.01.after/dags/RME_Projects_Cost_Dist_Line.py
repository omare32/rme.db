...
def Cost_Dist_Line_ETL():
    try:
        ...
        RES = fx.connection(spark, 'RES', 'RMEDB', Projects_Cost_Dist_Line_query, 'TEMP', 'ERP')
...
dag = DAG('Cost_Dist_Line',catchup=False,default_args=default_args,schedule_interval='00 00 * * *',tags=['0'])
