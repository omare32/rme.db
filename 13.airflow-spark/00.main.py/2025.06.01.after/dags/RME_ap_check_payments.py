...
def AP_Check_PaymentETL():
    spark = fx.spark_app('RME_ap_check_payments','4g','4')
    RES = fx.connection(spark,'RES','RMEDB',AP_Check_Paymentquery,'TEMP','ERP')
...
dag = DAG('AP_Check_Payment',catchup=False,default_args=default_args,schedule_interval='0 3 * * *',tags=['5'])
...
ReadRME_ap_check_paymentsTask= PythonOperator(dag=dag,
                ...
                python_callable=AP_Check_PaymentETL) 
