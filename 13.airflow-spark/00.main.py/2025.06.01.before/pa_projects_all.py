...
dag = DAG('Projects_All',catchup=False,default_args=default_args,schedule_interval='00 1 * * *',tags=['5'])


pa_projects_allTask= PythonOperator(dag=dag,
                task_id = 'Projects_All',
                python_callable=Projects_All_ETL) 
