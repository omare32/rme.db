    ...
    <div className="App">
      ...
      <Section title="Introduction" id="introduction" bgColor="bg-white">
        <p className="text-lg mb-6">
          The Construction Document Approval Tracking System is a comprehensive web-based solution designed to streamline and automate the approval processes for construction projects. This proposal outlines a system that will transform how contractors, consultants, and owners collaborate on document approvals, ensuring transparency, efficiency, and accountability throughout the project lifecycle.
        </p>
        <p className="text-lg mb-6">
          Our proposed system addresses the critical need for organized tracking of inspection requests, shop drawings, material approvals, and other essential construction documents. By digitizing these workflows, we eliminate the inefficiencies of paper-based processes while providing real-time visibility into approval statuses for all stakeholders.
        </p>
      </Section>
      ...
      <Section title="System Overview" id="overview" bgColor="bg-gray-50">
        <p className="text-lg mb-8">
          The Construction Document Approval Tracking System is built around nine key document types, each with specific approval workflows:
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <FeatureCard 
            title="Inspection Requests (IRs)" 
            description="Contractor-initiated requests for inspection of completed construction activities, selected from a predefined list. Consultants review and assign codes (A/B/C/D)."
          />
          <FeatureCard 
            title="Shop Drawings (SDs)" 
            description="Technical drawings submitted by contractors for approval before fabrication. Consultants review and assign codes (A/B/C)."
          />
          <FeatureCard 
            title="Material Submittals" 
            description="Specifications and samples of materials proposed for use in construction. Follows similar approval workflow to shop drawings."
          />
          <FeatureCard 
            title="Non-Conformance Reports (NCRs)" 
            description="Documentation of work that doesn't meet specifications. Remains open until contractor resolves the issue."
          />
          <FeatureCard 
            title="Material Inspection Requests (MIRs)" 
            description="Similar to IRs but specifically for inspecting delivered materials on site."
          />
          <FeatureCard 
            title="Invoices" 
            description="Monthly contractor submissions that require consultant approval before being sent to the owner/client."
          />
          <FeatureCard 
            title="Requests for Information (RFIs)" 
            description="Contractor questions requiring consultant clarification."
          />
          <FeatureCard 
            title="Requests for Change (RFCs)" 
            description="Formal requests for changes to project scope, specifications, or timeline."
          />
          <FeatureCard 
            title="Time Schedules" 
            description="Project timelines submitted by contractors for consultant review and approval."
          />
        </div>
      </Section>
      ...
      <Section title="User Roles and Permissions" id="roles" bgColor="bg-white">
        <p className="text-lg mb-8">
          The system supports three primary user roles, each with specific permissions and capabilities:
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <RoleCard 
            title="Contractor" 
            responsibilities={[
              "Submit inspection requests from predefined activity list",
              "Request additions to the activity list",
              "Submit shop drawings and material specifications",
              "Respond to NCRs and address issues",
              "Submit invoices, RFIs, RFCs, and time schedules",
          ...
          <RoleCard 
            ...
            responsibilities={[
              ...
              "Respond to RFIs and review RFCs",
          ...
          <RoleCard 
            ...
            responsibilities={[
              ...
              "Maintain oversight without direct approval responsibilities"
            ]}
          />
        </div>
      </Section>
      ...
      <Section title="Approval Cycle Workflows" id="workflows" bgColor="bg-gray-50">
        <p className="text-lg mb-8">
          To visually represent the core approval workflows, we have developed flowcharts for the primary document types. 
          These illustrate the interaction between roles and the decision points within the system:
        </p>
        
        <h3 className="text-xl font-semibold mb-4">Inspection Request (IR) Flow</h3>
        <p className="mb-6 text-gray-700">This chart shows the process from activity selection and submission by the Contractor, through Consultant review and coding (A/B/C/D), including the revision loop for rejected IRs.</p>
        <MermaidDiagram chart={irFlowchart} id="ir-flow" />
        
        <h3 className="text-xl font-semibold mb-4">Shop Drawing (SD) Flow</h3>
        <p className="mb-6 text-gray-700">This chart details the submission, Consultant review (Codes A/B/C), and the revision cycle required for B/C coded submittals until full approval (Code A).</p>
        <MermaidDiagram chart={sdFlowchart} id="sd-flow" />
        
        <h3 className="text-xl font-semibold mb-4">Material Submittal Flow</h3>
        <p className="mb-6 text-gray-700">This chart mirrors the SD flow but is specific to material specifications, showing the path to achieving full approval (Code A) via potential revision cycles.</p>
      ...
      <Section title="Conclusion" id="conclusion" bgColor="bg-white">
        <p className="text-lg mb-6">
          The Construction Document Approval Tracking System represents a significant advancement in how construction projects are managed and documented. By implementing this system, your organization will benefit from streamlined workflows, reduced administrative burden, and improved project visibility.
        </p>
        <p className="text-lg mb-6">
