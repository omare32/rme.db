...
def create_interface():
    ...
    with gr.Blocks(title="RME PO Query Assistant", css="footer {visibility: hidden}") as interface:
        with gr.Row():
            with gr.Column(scale=1):
                gr.Image("static/rme.png", show_label=False, height=60, width=100, container=False)
...
if __name__ == "__main__":
    ...
    interface.launch(server_name="localhost", server_port=7863)
