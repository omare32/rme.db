    ...
    """) as demo:
        ...
        with gr.Row():
            ...
            with gr.Column(scale=3):
                ...
                submit_event = msg.submit(process_question, [msg, chatbot, doc_paths], [chatbot, doc_paths, doc_buttons], show_progress=True)
                submit_click_event = submit.click(process_question, [msg, chatbot, doc_paths], [chatbot, doc_paths, doc_buttons], show_progress=True)
