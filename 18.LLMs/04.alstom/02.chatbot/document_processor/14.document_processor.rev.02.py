...
# Define paths
# Original local path: ALSTOM_DIR = "C:\\alstom"
# Updated to use network path
ALSTOM_DIR = "\\\\fileserver2\\Head Office Server\\Projects Control (PC)\\10 Backup\\05 Models\\alstom"
