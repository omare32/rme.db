...
def RME_Material_Movement_ETL():
    spark = fx.spark_app('RME_Material_Movement','12g','4')
    RES1 = fx.connection(spark,'RES1','RMEDB',RME_Material_Movement_query1,'TEMP1','ERP')
    RES2 = fx.connection(spark,'RES2','RMEDB',RME_Material_Movement_query2,'TEMP2','ERP')
    RES3 = fx.connection(spark,'RES3','RMEDB',RME_Material_Movement_query3,'TEMP3','ERP')
    RES4 = fx.connection(spark,'RES4','RMEDB',RME_Material_Movement_query4,'TEMP4','ERP')
    #RES5 = fx.connection(spark,'RES5','RMEDB',RME_Material_Movement_query5,'TEMP5','ERP')
    RES6 = fx.connection(spark,'RES6','RMEDB',RME_Material_Movement_query6,'TEMP6','ERP')
    RES7 = fx.connection(spark,'RES7','RMEDB',RME_Material_Movement_query7,'TEMP7','ERP')
    RES8 = fx.connection(spark,'RES8','RMEDB',RME_Material_Movement_query8,'TEMP8','ERP')
    RES9 = fx.connection(spark,'RES9','RMEDB',RME_Material_Movement_query9,'TEMP9','ERP')
    finalQuery=("""SELECT * FROM TEMP1
                UNION 
                SELECT * FROM TEMP2
                UNION ALL
                SELECT * FROM TEMP3
                ...
                SELECT * FROM TEMP9
                """)
    finaldf = fx.Transformation(spark,finalQuery)
    fx.WriteFunction(finaldf ,load_connection_string,'RME_Material_Movement_Report','overwrite',conn.mysql_username,conn.mysql_password)    
