...
\section{Key Skills}
\vspace{-1.5ex} % Adjust this value to reduce spacing
\begin{itemize}[leftmargin=*, itemsep=0.5ex] % itemsep reduces space between items
...
\vspace{-1ex} % Adjust spacing under section title
\begin{itemize}[leftmargin=*, itemsep=0.5ex] % Reduce space between items
