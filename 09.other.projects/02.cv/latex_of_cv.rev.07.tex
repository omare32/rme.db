...
% Adjust line spacing for first page only
\newcommand{\firstpagestart}{
    \setlength{\baselineskip}{1.2\baselineskip}  % Slightly reduced from 1.3
}
...
\firstpagestart  % Start increased spacing
...
\section{\mbox{Professional Experience}}  % Using \mbox to prevent line break
...
\end{itemize}
\end{multicols}
\vspace{\baselineskip}  % Add extra space at the bottom
\end{mdframed}

\clearpage  % Force a page break
\firstpageend  % Reset spacing for second page
