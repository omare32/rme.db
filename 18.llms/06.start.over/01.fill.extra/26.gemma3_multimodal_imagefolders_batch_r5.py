...
IMAGE_ROOT = r'D:\OEssam\Test\r5-pdf-images'  # Changed for R5 project
OUTPUT_DIR = r'D:\OEssam\Test\gemma3-r5'  # Changed for R5 project
PROCESSED_FILES_LOG = os.path.join(OUTPUT_DIR, 'processed_folders.txt') # Adjusted for new OUTPUT_DIR
