...
OUTPUT_DIR = r'D:\OEssam\Test\gemma3-again'
...
def process_pdf(pdf_path):
    ...
    doc.add_heading(f'Gemma3 Multimodal Summary: {pdf_filename_base}', 0)
    ...
    output_word_filename = f"gemma3_multimodal_summary_{pdf_filename_base}.docx"
