...
urlpatterns = [
    ...
    path('po_followup_report/', po_followup_views.po_followup_report, name='po_followup_report'),
    ...
    path('cost_dist_report/export/', cost_dist_views.export_to_excel, name='cost_dist_export'),
]
